...
def get_sidebar_config(kwargs=None):
    ...
    sidebar.append({"glyph": "glyphicon-book", "text": library_label, "link": 'web.index', "id": "new",
...
def get_cwa_last_notification() -> str:
    ...
    if not os.path.isfile(constants.CWA_UPDATE_NOTICE_PATH):
        with open(constants.CWA_UPDATE_NOTICE_PATH, 'w') as f:
            f.write(current_date)
        return "0001-01-01"
    else:
        with open(constants.CWA_UPDATE_NOTICE_PATH, 'r') as f:
